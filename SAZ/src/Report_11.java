...
public class Report_11 extends JFrame {
    ...
    void addComponents() { //自定义方法，添加组件
        ...
        model.addColumn("客户编号"); //添加一列，列名为员工编号
        model.addColumn("订单年份");
        model.addColumn("订单总额");
        model.addColumn("订单量排名");
