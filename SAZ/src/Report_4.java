...
public class Report_4 extends JFrame {
    ...
    void addComponents() { //自定义方法，添加组件
        ...
        model.addColumn("产品编号"); //添加一列，列名为员工编号
        model.addColumn("销售年份");
        model.addColumn("销售月份");
        model.addColumn("销售总额");
